...
class User extends CI_Controller {
		...
		if($param1 == 'add'){
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($add_airmail_registration) {
					...
					redirect('user/airmail-service-registration/list', 'refresh');
			...
			$data['page']       				= 'backEnd/user/airmail_registration_add';
			$data['activeMenu'] 				= 'airmail_registration_add';

		}elseif($param1 == 'list'){
			
			
			$data['airmail_registration_list']  = $this->UserModel->get_airmail_registration_list($param2);
			...
			$data['page']       				= 'backEnd/user/airmail_registration_list';
			...
			$data['invoice_list']  				= $this->UserModel->get_airmail_invoice_list($param2);

			$data['title']						= 'Airmail Registration Invoice';
			$data['activeMenu'] 				= 'airmail_registration_invoice';
			$data['page'] 						= 'backEnd/user/airmail_registration_invoice';
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($this->UserModel->update_airmail_registration($update_airmail_registration, $param2)) {
			...
			$data['page'] 					= 'backEnd/user/airmail_registration_edit';

		}elseif($param1 == 'delete' && $param2 > 0) {
			
			if ($this->UserModel->delete_airmail_registration($param2)) {
		...
		if($param1 == 'add'){
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($add_lounge_registration) {
					...
					redirect('user/lounge-service-registration/list', 'refresh');
			...
			$data['page']       			= 'backEnd/user/lounge_registration_add';
			$data['activeMenu'] 			= 'lounge_registration_add';

		}elseif($param1 == 'list'){
			
			
			$data['lounge_registration_list']   = $this->UserModel->get_lounge_registration_list($param2);
			
			$data['lounge_type_list'] 			= $this->db->select('id, name')->get('tbl_lounge_type')->result();
			$data['title']      				= 'Lounge Service Registration List ';
			$data['page']       				= 'backEnd/user/lounge_registration_list';
			...
			$data['client_details']   			= $this->db->select('id, name, phone_number, email, passport_number')->get_where('tbl_clients',array('id'=>$client_id))->row();
			$data['invoice_list']  				= $this->UserModel->get_lounge_invoice_list($param2);

			$data['title']						= 'Lounge Registration Invoice';
			$data['activeMenu'] 				= 'lounge_registration_invoice';
			$data['page'] 						= 'backEnd/user/lounge_registration_invoice';
		}elseif($param1 == 'edit' && $param2 > 0){
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($this->UserModel->update_lounge_registration($update_lounge_registration, $param2)) {
			...
			$data['page'] 					= 'backEnd/user/lounge_registration_edit';

		}elseif($param1 == 'delete' && $param2 > 0) {
			
			if ($this->UserModel->delete_lounge_registration($param2)) {
		...
		if($param1 == 'add'){
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($add_service_registration) {
					...
					redirect('user/mga-service-registration/list', 'refresh');
			...
			$data['page']       				= 'backEnd/user/mga_service_registration_add';
			$data['activeMenu'] 				= 'mga_service_registration_add';

		}elseif($param1 == 'list'){
			
			
			$data['service_registration_list']  = $this->UserModel->get_service_registration_list($param2);
			$data['mga_type_list'] 			    = $this->db->select('id, name')->get('tbl_mga_service_type')->result();


			$data['title']      				= 'Mga Service Registration List ';
			$data['page']       				= 'backEnd/user/mga_service_registration_list';
			...
			$data['client_details']   			= $this->db->select('id, name, phone_number, email, passport_number')->get_where('tbl_clients',array('id'=>$client_id))->row();
			$data['invoice_list']  				= $this->UserModel->get_mga_invoice_list($param2);

			$data['title']						= 'Mga Service Registration Invoice';
			$data['activeMenu'] 				= 'mga_registration_invoice';
			$data['page'] 						= 'backEnd/user/mga_service_registration_invoice';
		}elseif($param1 == 'edit' && $param2 > 0){
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($this->UserModel->update_service_registration($update_service_registration, $param2)) {
			...
			$data['page'] 					= 'backEnd/user/mga_service_registration_edit';

		}elseif($param1 == 'delete' && $param2 > 0) {
			
			if ($this->UserModel->delete_service_registration($param2)) {
		...
		if($param1 == 'add'){
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($add_shuttle_registration) {
					...
					redirect('user/shuttle-service-registration/list', 'refresh');
			...
			$data['page']       				= 'backEnd/user/shuttle_registration_add';
			$data['activeMenu'] 				= 'shuttle_registration_add';

		}elseif($param1 == 'list'){

			$data['shuttle_registration_list']  = $this->UserModel->get_shuttle_registration_list($param2);

			$data['shuttle_type_list'] 			= $this->db->select('id, name')->get('tbl_shuttle_type')->result();
			$data['title']      				= 'Shuttle Service Registration List ';
			$data['page']       				= 'backEnd/user/shuttle_registration_list';
			...
			$data['client_details']   			= $this->db->select('id, name, phone_number, email, passport_number')->get_where('tbl_clients',array('id'=>$client_id))->row();
			$data['invoice_list']  				= $this->UserModel->get_shuttle_invoice_list($param2);

			$data['title']						= 'Shuttle Registration Invoice';
			$data['activeMenu'] 				= 'shuttle_registration_invoice';
			$data['page'] 						= 'backEnd/user/shuttle_registration_invoice';
		}elseif($param1 == 'edit' && $param2 > 0){
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($this->UserModel->update_shuttle_registration($update_shuttle_registration, $param2)) {
			...
			$data['page'] 					= 'backEnd/user/shuttle_registration_edit';

		}elseif($param1 == 'delete' && $param2 > 0) {
			
			if ($this->UserModel->delete_shuttle_registration($param2)) {
		...
		if ($param1 == 'add') {
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($add_client) {
					...
					redirect('user/client/list', 'refresh');
			...
			$data['page']               = 'backEnd/user/client_add';
			...
			$data['page']         		= 'backEnd/user/client_list';
			...
			if ($data['edit_info']->num_rows() > 0) {
				...
				if ($_SERVER['REQUEST_METHOD'] == 'POST') {
					...
					if ($this->UserModel->update_client($update_client, $param2)) {
			...
			$data['page']       = 'backEnd/user/client_edit';
			
		   
		} elseif($param1 == 'delete' && $param2 > 0) {
			
		   if ($this->UserModel->delete_client($param2)) {
		...
		if($param1 == 'add'){
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if ($invoice) {
					...
					redirect('user/invoice/list', 'refresh');
			...
			$data['page']       		= 'backEnd/user/invoice_add';
			$data['activeMenu'] 		= 'invoice_add';

		}elseif($param1 == 'list'){
			
			
			$data['invoice_list']  		= $this->UserModel->get_invoice_list();

			$data['title']      		= 'Invoice List';
			$data['page']       		= 'backEnd/user/invoice_list';
			...
			if($client->num_rows() > 0){
				...
				$data['invoice_view_mga']  		= $this->UserModel->get_mga_invoice_row($invoice_number);
				$data['invoice_view_lounge']  	= $this->UserModel->get_lounge_invoice_row($invoice_number);
				$data['invoice_view_shuttle']  	= $this->UserModel->get_shuttle_invoice_row($invoice_number);
				$data['invoice_view_airmail']  	= $this->UserModel->get_airmail_invoice_row($invoice_number);
			...
			$data['page'] 					= 'backEnd/user/invoice_view';

		}elseif($param1 == 'delete' && $param2 > 0) {

			if ($this->UserModel->delete_invoice_by_invoice_number($param2)) {
	...
	public function seles_report($param1 = '', $param2 = '', $param3 = '') 
	{
		if($param1 == 'add'){
			...
			$data['page']       		= 'backEnd/user/seles_report';
			...
			$this->session->set_flashdata('message', 'Wrong Attempt!');
			redirect('user/seles-report/list', 'refresh');
