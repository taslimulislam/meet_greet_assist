         ...
         <table class="table table-striped">
            <thead>
               <tr>
                  ...
                  <th style="width: 15%;"><?php echo $this->lang->line('received_from'); ?></th>
                  <th style="width: 15%;"><?php echo $this->lang->line('drop_to'); ?></th>
                  <th style="width: 15%;"><?php echo $this->lang->line('received_date'); ?></th>
               </tr>
            </thead>
            <tbody>
               <?php 
