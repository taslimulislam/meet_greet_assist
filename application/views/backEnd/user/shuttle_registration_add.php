<section class="content">
    <div class="row">
        <form action="<?php echo base_url("user/shuttle-service-registration/add");?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-3">
                <!-- Horizontal Form -->
            ...
            <div class="col-md-6">
                ...
                <div class="box box-success box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <!-- <a href="<?php echo base_url() ?>user/shuttle-service-registration/list" class="btn bg-red btn-sm" style="color: white;"> <i class="fa fa-list"></i> <?php echo $this->lang->line('shuttle_registration_list'); ?> </a> -->
                        </div>
                    </div>
                    <div class="box-body" style="min-height: 316px;">
                        <div class="row">
