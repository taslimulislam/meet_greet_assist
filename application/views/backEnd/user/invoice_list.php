            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url('user/invoice/add') ?>" class="btn bg-red btn-sm"><i class="fa fa-plus"></i> <?php echo $this->lang->line('invoice_add'); ?></a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <a href="<?php echo base_url('user/invoice/delete/'.$value->invoice_number); ?>" class="btn btn-sm btn-danger" onclick = 'return confirm("Are You Sure?")'><i class="fa fa-trash"></i></a>
                                    <a href="<?php echo base_url().'user/invoice_status/'.$value->id.'/'. abs($value->approve_status-1) ;?>" > <?php echo $value->approve_status == 1 ? '<i class="btn btn-sm btn-success fa fa-thumbs-o-up"></i>':'<i class="btn btn-sm btn-warning fa fa-thumbs-o-down"></i>'; ?> </a>
                                </td>  
                            </tr>
                            <?php
                               }
