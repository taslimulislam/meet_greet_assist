<section class="content">
    <div class="row">
        <form action="<?php echo base_url('user/invoice/add/') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-12">
                <!-- Horizontal Form -->
...
<script>
    $(document).ready(function () {
        ...
        $('#lounge_service_station_id').change(function () {
            ...
            //alert(service_station_id);
            $.post("<?php echo base_url() . "user/get_lounge_service_station_rate"; ?>",
...
<script>
    ...
    function loadLoungeType() {
        ...
        $.post("<?php echo base_url() . "user/get_lounge_type"; ?>",
                {'asd': 'asd'},
                function (data2) {
    ...
    function loadLoungeStation(typeId) {
        ...
        $.post("<?php echo base_url() . "user/get_lounge_station/"; ?>" + typeId,
                {'nothing': 'nothing'},
                function (data2) {
                    var data = JSON.parse(data2);
                    $.each(data, function (i, item) {
...
<script>
    $(document).ready(function () {
        ...
        $('#shuttle_service_station_id').change(function () {
            ...
            //alert(service_station_id);
            $.post("<?php echo base_url() . "user/get_shuttle_service_station_rate"; ?>",
...
<script>
    ...
    function loadShuttleType() {
        ...
        $.post("<?php echo base_url() . "user/get_shuttle_type"; ?>",
                {'asd': 'asd'},
                function (data2) {
    ...
    function loadShuttleStation(typeId) {
        ...
        $.post("<?php echo base_url() . "user/get_shuttle_station/"; ?>" + typeId,
                {'nothing': 'nothing'},
                function (data2) {
                    var data = JSON.parse(data2);
                    $.each(data, function (i, item) {
...
<script>
    ...
    function loadAirmailType() {
        ...
        $.post("<?php echo base_url() . "user/get_airmail_type"; ?>",
                {'asd': 'asd'},
                function (data2) {
    ...
    function loadAirmailStation(typeId) {
        ...
        $.post("<?php echo base_url() . "user/get_airmail_station/"; ?>" + typeId,
                {'nothing': 'nothing'},
                function (data2) {
                    var data = JSON.parse(data2);
                    $.each(data, function (i, item) {
