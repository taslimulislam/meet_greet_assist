        ...
        <div class="col-md-12">
            ...
            <div class="box box-info box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo $this->lang->line('division_add'); ?>  </h3>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input name="name" placeholder="<?php echo $this->lang->line('division_name'); ?> " class="form-control inner_shadow_info" required="" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4"></div>
