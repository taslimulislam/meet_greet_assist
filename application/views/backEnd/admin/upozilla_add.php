        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"> <?php echo $this->lang->line('upozilla_add'); ?> </h3>
                ...
                <div class="box-body">
                    <div class="row">
                        <form action="<?php echo base_url("admin/upozilla/add");?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="col-md-12"> 
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input name="name" placeholder="<?php echo $this->lang->line('upozilla_name'); ?>" class="form-control inner_shadow_primary" required="" type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
