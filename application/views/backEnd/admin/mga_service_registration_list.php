        ...
        <div class="col-xs-12">
            <div class="box box-teal box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo $this->lang->line('service_registration_list'); ?></h3>
                    
                        
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url('admin/mga-service-registration/add') ?>" class="btn bg-purple btn-sm"><i class="fa fa-plus"></i> <?php echo $this->lang->line('service_registration_add'); ?></a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="col-md-12">
                        <center>
                            <div class="btn-group">
                                ...
                                ?>
                                    <a href="<?php echo base_url('admin/mga-service-registration/list/'.$value->id); ?>"  class="btn btn-primary"><?php echo $value->name; ?></a>
                                <?php
                                    }
                                ?>
                            </div>
                    ...
                    <table id="userListTable" class="table table-bordered table-striped table_th_teal">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th style="width: 12%;"><?php echo $this->lang->line('service_type'); ?></th>
                                <th style="width: 12%;"><?php echo $this->lang->line('service_station'); ?></th>
                                <th style="width: 10%;"><?php echo $this->lang->line('start_time'); ?></th>
                                <th style="width: 10%;"><?php echo $this->lang->line('landing_time'); ?></th>
                                <th style="width: 12%;"><?php echo $this->lang->line('journy_date'); ?></th>
                        ...
                        <tbody>
                            <?php 
                                $sl = 1;
                                if ($service_registration_list){

                                foreach ($service_registration_list as $value){ 
                            ?>
                            <tr>
                                <td> <?php echo $sl++ ; ?> </td>
