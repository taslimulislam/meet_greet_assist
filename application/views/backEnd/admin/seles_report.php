            ...
            <div class="box box-danger box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="box-shadow: 0px 0px 10px 0px #dd4b39;margin: 10px 30px 40px 25px;padding: 30px 0px 30px 0px;">
                        ...
                        <form action="<?php echo base_url('admin/seles-report/list/') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <select name="agent_id" class="form-control select2 inner_shadow_teal">
                                            <option value="" selected><?php echo $this->lang->line('select_agent'); ?></option>
                                            <?php foreach ($agent_list as $value) { ?>
                                                <option  value="<?php echo $value->id; ?>" <?php if($agent_id == $value->id) echo 'selected'; ?> ><?php echo $value->firstname; ?></option>
                                            <?php } ?>
                                        </select>
