...
<section class="content">
    <div class="row">
        <div class="col-md-3">
            <!-- Profile Image -->
            <form action="<?php echo base_url('agent/profile/update_photo') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="active tab-pane" id="user_info">
                        <form class="form-horizontal" action="<?php echo base_url('agent/profile/update_info') ?>"      method="post">
                    ...
                    <div class="tab-pane" id="pass_change">
                        <form class="form-horizontal" action="<?php echo base_url('agent/profile/update_pass') ?>" method="post">
                            <div class="form-group">
...
<script>
    ...
    function loadDivision() {
    		...
    		$.post("<?php echo base_url() . "agent/get_division"; ?>",
    						{'asd': 'asd'},
    						function (data2) {
    ...
    function loadZilla(divisionId) {
    		$.post("<?php echo base_url() . "agent/get_zilla_from_division/"; ?>" + divisionId,
    						{'nothing': 'nothing'},
    						function (data2) {
    								var data = JSON.parse(data2);
    ...
    function loadUpozilla(zillaId) {
    		$.post("<?php echo base_url() . "agent/get_upozilla_from_division_zilla/"; ?>" + zillaId,
    						{'nothing': 'nothing'},
    						function (data2) {
    								var data = JSON.parse(data2);
    								$.each(data, function (i, item) {
