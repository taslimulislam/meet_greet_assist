<section class="content">
    <div class="row">
        <form action="<?php echo base_url('agent/invoice/add/') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-12">
                <!-- Horizontal Form -->
...
<script>
    $(document).ready(function () {
        ...
        $('#mga_service_station_id').change(function () {
            ...
            $.post("<?php echo base_url() . "agent/get_mga_service_station_rate"; ?>",
...
<script>
    ...
    function loadMgaType() {
        ...
        $.post("<?php echo base_url() . "agent/get_mga_type"; ?>",
                {'asd': 'asd'},
                function (data2) {
    ...
    function loadMgaStation(typeId) {
        ...
        $.post("<?php echo base_url() . "agent/get_mga_station/"; ?>" + typeId,
                {'nothing': 'nothing'},
                function (data2) {
                    var data = JSON.parse(data2);
