<section class="content">
    <div class="row">
        <form action="<?php echo base_url("agent/airmail-service-registration/add");?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-3">
                <!-- Horizontal Form -->
            ...
            <div class="col-md-6">
                ...
                <div class="box box-danger box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <!-- <a href="<?php echo base_url() ?>agent/airmail-service-registration/list" class="btn bg-green btn-sm" style="color: white;"> <i class="fa fa-list"></i> <?php echo $this->lang->line('airmail_registration_list'); ?> </a> -->
                        </div>
                    </div>
                    <div class="box-body" style="min-height: 430px;">
                        <div class="row">
...
<script>
    ...
    function loadAirmailType() {
        ...
        $.post("<?php echo base_url() . "agent/get_airmail_type"; ?>",
                {'asd': 'asd'},
                function (data2) {
    ...
    function loadAirmailStation(typeId) {
        ...
        $.post("<?php echo base_url() . "agent/get_airmail_station/"; ?>" + typeId,
                {'nothing': 'nothing'},
                function (data2) {
                    var data = JSON.parse(data2);
