            ...
            <div class="box box-success box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url('agent/shuttle-service-registration/add') ?>" class="btn bg-red btn-sm"><i class="fa fa-plus"></i> <?php echo $this->lang->line('shuttle_registration_add'); ?></a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="col-md-12">
                        <center>
                            <div class="btn-group">
                                ...
                                ?>
                                    <a href="<?php echo base_url('agent/shuttle-service-registration/list/'.$value->id); ?>"  class="btn btn-primary"><?php echo $value->name; ?></a>
                                <?php
                                    }
                                ?>
                            </div>
