         ...
         <table class="table table-striped">
            <thead>
               <tr>
                  ...
                  <th style="width: 15%;"><?php echo $this->lang->line('airliens_id'); ?></th>
                  <th style="width: 15%;"><?php echo $this->lang->line('start_from'); ?></th>
                  <th style="width: 15%;"><?php echo $this->lang->line('end_to'); ?></th>
                  <th style="width: 15%;"><?php echo $this->lang->line('travel_date'); ?></th>
               </tr>
            </thead>
            <tbody>
               <?php 
               ...
               <tr>
                  ...
                  <td> <?php echo $value->airlines_id; ?> </td>
