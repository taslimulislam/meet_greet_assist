	...
	class AdminModel extends CI_Model{
		...
		public function update_testimonials($update_testimonials, $param2)
		{
		 if (isset($update_testimonials['photo']) && file_exists($update_testimonials['photo'])) {
			...
			$result = $this->db->select('photo')->from('testimonials')->where('id',$param2)->get()->row()->photo;
		...
		//Division Update
		public function update_division($update_division, $param2)
		{
		...
		//zilla Update
		public function update_zilla($update_zilla, $param2)
		{
		...
		//Zilla Delete
		public function delete_zilla($param2)
		{
		...
		//Upozilla Update
		public function update_upozilla($update_upozilla, $param2)
		{
		 
		 return $this->db->where('id',$param2)->update('tbl_upozilla',$update_upozilla);
		}
	
		//Upozilla Delete
		public function delete_upozilla($param2)
		{
		...
		//Main Service Update
		public function update_main_service($update_main_service, $param2)
		{
		 
		 return $this->db->where('id',$param2)->update('tbl_main_services',$update_main_service);
		}
	
		//Main Service Delete
		public function delete_main_service($param2)
		{
			  
			return $this->db->where('id',$param2)->delete('tbl_main_services'); 
		}
		...
		{
			$query = $this->db->select('tbl_gallery.*,tbl_gallery_category.name')->from('tbl_gallery')
		...
		//Mga service Station Update
		public function update_service_station($update_mga_station, $param2)
		{
		 
		 return $this->db->where('id',$param2)->update('tbl_mga_service_stations',$update_mga_station);
		}
	
		//Mga service Station Delete
		public function delete_service_station($param2)
		{
			  
			return $this->db->where('id',$param2)->delete('tbl_mga_service_stations'); 
		}

		//Mga service Station List 
		public function get_mga_station_list($param2 = '0')
		{

			$data = array();
			$this->db->select('tbl_mga_service_stations.id, tbl_mga_service_stations.name, tbl_mga_service_stations.unit_rate, tbl_mga_service_type.name as mga_type_name');
			$this->db->join('tbl_mga_service_type', 'tbl_mga_service_type.id = tbl_mga_service_stations.mga_service_type_id', 'left');
			$this->db->order_by('tbl_mga_service_stations.priority', 'asc');

			if($param2 > 0){
				$this->db->where('tbl_mga_service_stations.mga_service_type_id', $param2);
			}
			$data   = $this->db->get('tbl_mga_service_stations');
			return $data->result();
		...
		//Lounge type Update
		public function update_lounge_type($update_lounge_type, $param2)
		{
		 
		 return $this->db->where('id',$param2)->update('tbl_lounge_type',$update_lounge_type);
		}
	
		//Lounge type Delete
		public function delete_lounge_type($param2)
		{
			  
			return $this->db->where('id',$param2)->delete('tbl_lounge_type'); 
		}


		//Lounge Service Station Update
		public function update_lounge_station($update_lounge_station, $param2)
		{
		 
		 return $this->db->where('id',$param2)->update('tbl_lounge_service_stations',$update_lounge_station);
		}
	
		//Lounge Service Station Delete
		public function delete_lounge_station($param2)
		{
			  
			return $this->db->where('id',$param2)->delete('tbl_lounge_service_stations'); 
		}

		//Lounge Station List List 
		public function get_lounge_station_list($param2 = '0')
		{

			$data = array();
			$this->db->select('tbl_lounge_service_stations.id, tbl_lounge_service_stations.name, tbl_lounge_service_stations.unit_rate, tbl_lounge_type.name as lounge_type_name');
			$this->db->join('tbl_lounge_type', 'tbl_lounge_type.id = tbl_lounge_service_stations.lounge_service_type_id', 'left');
			$this->db->order_by('tbl_lounge_service_stations.priority', 'asc');


			if($param2 > 0){
				$this->db->where('tbl_lounge_service_stations.lounge_service_type_id', $param2);
			}
			$data   = $this->db->get('tbl_lounge_service_stations');
			return $data->result();
		...
		//Shuttle type Update
		public function update_shuttle_type($update_shuttle_type, $param2)
		{
		 
		 return $this->db->where('id',$param2)->update('tbl_shuttle_type',$update_shuttle_type);
		}
	
		//Shuttle type Delete
		public function delete_shuttle_type($param2)
		{
			  
			return $this->db->where('id',$param2)->delete('tbl_shuttle_type'); 
		}

		//Shuttle Service Station Update
		public function update_shuttle_station($update_shuttle_station, $param2)
		{
		 
		 return $this->db->where('id',$param2)->update('tbl_shuttle_service_stations',$update_shuttle_station);
		}
	
		//Shuttle Service Station Delete
		public function delete_shuttle_station($param2)
		{
			  
			return $this->db->where('id',$param2)->delete('tbl_shuttle_service_stations'); 
		}

		//Shuttle Station List 
		public function get_shuttle_station_list($param2 = '0')
		{
			$data = array();
			$this->db->select('tbl_shuttle_service_stations.id, tbl_shuttle_service_stations.name, tbl_shuttle_service_stations.unit_rate,tbl_shuttle_type.name as shuttle_type_name');
			$this->db->join('tbl_shuttle_type', 'tbl_shuttle_type.id = tbl_shuttle_service_stations.shuttle_service_type_id', 'left');
			$this->db->order_by('tbl_shuttle_service_stations.priority', 'asc');

			if($param2 > 0){
				$this->db->where('tbl_shuttle_service_stations.shuttle_service_type_id', $param2);
			}
			$data   = $this->db->get('tbl_shuttle_service_stations');
			return $data->result();
		...
		//Airmail service Station List 
		public function get_airmail_station_list($param2 = '0')
		{

			$data = array();
			$this->db->select('tbl_airmail_service_stations.id, tbl_airmail_service_stations.name, tbl_airmail_service_type.name as airmail_type_name');
			$this->db->join('tbl_airmail_service_type', 'tbl_airmail_service_type.id = tbl_airmail_service_stations.airmail_service_type_id', 'left');
			
			if($param2 > 0){
				$this->db->where('tbl_airmail_service_stations.airmail_service_type_id', $param2);
			}
			
			$this->db->order_by('tbl_airmail_service_stations.priority', 'asc');
			$data   = $this->db->get('tbl_airmail_service_stations');
			return $data->result();

		}

		//Airmail Service Station Update
		public function update_airmail_station($update_airmail_station, $param2)
		{
		 
		 return $this->db->where('id',$param2)->update('tbl_airmail_service_stations',$update_airmail_station);
		}

		//Airmail Service Station Delete
		public function delete_airmail_station($param2)
		{
			  
			return $this->db->where('id',$param2)->delete('tbl_airmail_service_stations'); 
		}
